...
PHRASES = {
    Language.CA: Phrases(
        ...
        handoff="Un moment, us passo amb un company del centre.",
    ),
    Language.ES: Phrases(
        name="Spanish",
        ...
        handoff="Un momento, le paso con un compañero del centro.",
    ),
    Language.EN: Phrases(
        name="English",
        ...
        handoff="One moment, I will put you through to a colleague.",
    ),
}
